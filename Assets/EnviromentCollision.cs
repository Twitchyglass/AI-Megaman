...
public class EnviromentCollision : MonoBehaviour
{
	...
	void Update()
	{
		Debug.DrawLine(new Vector3(m_left, m_top), new Vector3(m_left, m_bottom), Color.red);
		Debug.DrawLine(new Vector3(m_right, m_bottom),new Vector3(m_right, m_top) , Color.red);
		Debug.DrawLine(new Vector3(m_right, m_top),new Vector3(m_left, m_top) , Color.red);
		Debug.DrawLine(new Vector3(m_left, m_bottom), new Vector3(m_right, m_bottom), Color.red);
	}
